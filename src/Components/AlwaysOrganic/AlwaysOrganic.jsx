...
const AlwaysOrganic = () => {
    return (
        <div className="flex flex-col lg:flex-row items-center justify-between bg-gray-100 p-10 lg:p-20">
            <motion.div
            ...
            >
                <h3 className="text-yellow-500 text-2xl mb-4">Always Organic</h3>
